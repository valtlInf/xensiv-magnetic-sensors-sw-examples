...
** V0.3.3: 2022-10-18, VO:   EP-1252: Updated enums, unions and structs       **
** V0.3.4: 2025-01-02, JO:   EP-1493: Updated license                         **
*******************************************************************************/
 ...
 */
typedef union User_MAPRAM_Init
{
  uint8   reg;
  struct
  {
 ...
 */
typedef union User_NVM_ECC_Check
{
  uint8   reg;
  struct
  {
 ...
 */
typedef union User_ERASE_SECTOR_VERIFY
{
  uint8   reg;
  struct
  {
 ...
 */
typedef union User_ERASEPG_VERIFY
{
  uint8   reg;
  struct
  {
 ...
 */
typedef union User_VERIFY_PAGE
{
  uint8   reg;
  struct
  {
