...
** V0.2.5: 2023-03-09, BG:   EP-1012: Included GCC compatibility in the DMA   **
**                           channel structure definitions                    **
** V0.2.6: 2024-11-20, JO:   EP-1547: Corrected function DMA_Setup_Channel    **
** V0.2.7: 2025-01-02, JO:   EP-1493: Updated license                         **
*******************************************************************************/
...
/** \brief DMA source increment */
#define DMA_SRC_INCREMENT 1u
/** \brief DMA destination increment */
...
typedef enum DMA_Increment_Mode
{
  ...
  DMA_Src_Inc      = DMA_SRC_INCREMENT,                        /**< DMA Increment Codes macro, Source Address Increment */
  DMA_Dst_Inc      = DMA_DEST_INCREMENT,                       /**< DMA Increment Codes macro, Destination Address Increment */
  DMA_Src_Dst_Inc  = (DMA_SRC_INCREMENT | DMA_DEST_INCREMENT)  /**< DMA Increment Codes macro, Source and Destination Address Increment */
} TDMA_Increment_Mode;
