#include "Sensor/Interface/SPI_Frontend/SPIFrontend.h"
#include "Sensor/Interface/CRC8_SAE_J1850/CRC8_SAE_J1850.h"
...
uint32_t TLx49012_SPI_WriteInFrame(uint8_t addr, uint16_t data)
{
	...
	return TLE987x_SPI_SendReceive(data_to_send);
}
