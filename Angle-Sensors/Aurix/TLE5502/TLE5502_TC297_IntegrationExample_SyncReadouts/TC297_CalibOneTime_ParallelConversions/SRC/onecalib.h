...
typedef struct ROTATION_DATA_STORE {
        ...
        float offsetX; /*!< amplitude of COS signal. */
        float offsetY; /*!< amplitude of SIN signal. */
...
typedef struct CALIB_DATA {
        ...
        float mean_amplitudeX; /*!< mean amplitude of COS signal from CW and CCW rotation. */
        float mean_amplitudeY; /*!< mean amplitude of SIN signal from CW and CCW rotation. */

        float mean_offsetX; /*!< mean offset of COS signal from CW and CCW rotation. */
        float mean_offsetY; /*!< mean offset of SIN signal from CW and CCW rotation. */
...
void ONECALIB_InitSensorData(float cosP_in_LSB, float cosN_in_LSB, float sinP_in_LSB, float sinN_in_LSB);
